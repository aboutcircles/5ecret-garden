...
export declare class CalculationContext {
    ...
    getOrCreateMemo<T>(key: string, generator: () => Promise<T>): Promise<T>;
}
/**
 ...
 */
export declare class CalculatedColumn<TRow extends EventRow> {
    readonly name: string;
    readonly generator: (row: TRow, context: CalculationContext) => Promise<unknown>;
    constructor(name: string, generator: (row: TRow, context: CalculationContext) => Promise<unknown>);
}
/**
