...
export type CirclesEvent = CrcV1_HubTransfer | CrcV1_Signup | CrcV1_OrganizationSignup | CrcV1_Trust | CrcV1_Transfer | CrcV1_TransferSummary | CrcV1_UpdateMetadataDigest | CrcV2_InviteHuman | CrcV2_PersonalMint | CrcV2_RegisterGroup | CrcV2_RegisterHuman | CrcV2_RegisterOrganization | CrcV2_Stopped | CrcV2_Trust | CrcV2_TransferSingle | CrcV2_Erc20WrapperTransfer | CrcV2_ERC20WrapperDeployed | CrcV2_URI | CrcV2_ApprovalForAll | CrcV2_TransferBatch | CrcV2_RegisterShortName | CrcV2_UpdateMetadataDigest | CrcV2_CidV0 | CrcV2_StreamCompleted | CrcV2_CreateVault | CrcV2_CollateralLockedSingle | CrcV2_CollateralLockedBatch | CrcV2_GroupMint | CrcV2_GroupRedeem | CrcV2_GroupRedeemCollateralReturn | CrcV2_GroupRedeemCollateralBurn | CrcV2_DepositDemurraged | CrcV2_DepositInflationary | CrcV2_WithdrawDemurraged | CrcV2_WithdrawInflationary | CrcV2_DiscountCost | CrcV2_TransferSummary | CrcV2_FlowEdgesScopeLastEnded | CrcV2_FlowEdgesScopeSingleStarted | CrcV2_CMGroupCreated | CrcV2_CirclesBackingDeployed | CrcV2_CirclesBackingInitiated | CrcV2_CirclesBackingCompleted | CrcV2_LBPDeployed | CrcV2_BaseGroupCreated | CrcV2_BaseGroupOwnerUpdated | CrcV2_BaseGroupServiceUpdated | CrcV2_BaseGroupFeeCollectionUpdated | Crc_UnknownEvent | Safe_AddedOwner | Safe_ProxyCreation | Safe_RemovedOwner | Safe_SafeSetup;
export type CirclesEventType = 'CrcV1_HubTransfer' | 'CrcV1_Signup' | 'CrcV1_OrganizationSignup' | 'CrcV1_Trust' | 'CrcV1_Transfer' | 'CrcV1_TransferSummary' | 'CrcV1_UpdateMetadataDigest' | 'CrcV2_InviteHuman' | 'CrcV2_PersonalMint' | 'CrcV2_RegisterGroup' | 'CrcV2_RegisterHuman' | 'CrcV2_RegisterOrganization' | 'CrcV2_Stopped' | 'CrcV2_Trust' | 'CrcV2_TransferSingle' | 'CrcV2_Erc20WrapperTransfer' | 'CrcV2_URI' | 'CrcV2_ApprovalForAll' | 'CrcV2_TransferBatch' | 'CrcV2_RegisterShortName' | 'CrcV2_UpdateMetadataDigest' | 'CrcV2_CidV0' | 'CrcV2_StreamCompleted' | 'CrcV2_CreateVault' | 'CrcV2_CollateralLockedSingle' | 'CrcV2_CollateralLockedBatch' | 'CrcV2_GroupMint' | 'CrcV2_GroupRedeem' | 'CrcV2_GroupRedeemCollateralReturn' | 'CrcV2_GroupRedeemCollateralBurn' | 'CrcV2_DepositDemurraged' | 'CrcV2_DepositInflationary' | 'CrcV2_WithdrawDemurraged' | 'CrcV2_WithdrawInflationary' | 'CrcV2_ERC20WrapperDeployed' | 'CrcV2_DiscountCost' | 'CrcV2_TransferSummary' | 'CrcV2_FlowEdgesScopeLastEnded' | 'CrcV2_FlowEdgesScopeSingleStarted' | 'CrcV2_CMGroupCreated' | 'CrcV2_CirclesBackingDeployed' | 'CrcV2_CirclesBackingInitiated' | 'CrcV2_CirclesBackingCompleted' | 'CrcV2_LBPDeployed' | 'CrcV2_BaseGroupCreated' | 'CrcV2_BaseGroupOwnerUpdated' | 'CrcV2_BaseGroupServiceUpdated' | 'CrcV2_BaseGroupFeeCollectionUpdated' | 'Crc_UnknownEvent' | 'Safe_AddedOwner' | 'Safe_ProxyCreation' | 'Safe_RemovedOwner' | 'Safe_SafeSetup';
