...
export declare class CMGAvatar implements AvatarInterfaceV2 {
    readonly sdk: Sdk;
    get address(): Address;
    readonly avatarInfo: AvatarRow;
    coreMemberGroup: CoreMembersGroup;
    ...
    trust(avatar: Address | Address[], expiry?: bigint): Promise<TransactionResponse>;
    ...
    setOwner(owner: Address): Promise<ContractTransactionReceipt>;
    setService(service: Address): Promise<ContractTransactionReceipt>;
    setMintHandler(mintHandler: Address): Promise<ContractTransactionReceipt>;
    setRedemptionHandler(service: Address): Promise<ContractTransactionReceipt>;
    setMinimalDeposit(minimalDeposit: bigint): Promise<ContractTransactionReceipt>;
    setFeeCollection(feeCollection: Address): Promise<ContractTransactionReceipt>;
    ...
    transfer(to: Address, amount: bigint, tokenAddress?: Address): Promise<TransactionReceipt>;
...
//# sourceMappingURL=cmgAvatar.d.ts.map