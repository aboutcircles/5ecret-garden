...
export interface HubInterface extends Interface {
    getFunction(nameOrSignature: "advancedUsageFlags" | "avatars" | "balanceOf" | "balanceOfBatch" | "balanceOfOnDay" | "burn" | "calculateIssuance" | "calculateIssuanceWithCheck" | "convertDemurrageToInflationaryValue" | "convertInflationaryToDemurrageValue" | "day" | "groupMint" | "inflationDayZero" | "invitationOnlyTime" | "isApprovedForAll" | "isGroup" | "isHuman" | "isOrganization" | "isPermittedFlow" | "isTrusted" | "migrate" | "mintPolicies" | "operateFlowMatrix" | "personalMint" | "registerCustomGroup" | "registerGroup" | "registerHuman" | "registerOrganization" | "safeBatchTransferFrom" | "safeTransferFrom" | "setAdvancedUsageFlag" | "setApprovalForAll" | "stop" | "stopped" | "supportsInterface" | "toTokenId" | "totalSupply" | "treasuries" | "trust" | "trustMarkers" | "uri" | "wrap"): FunctionFragment;
    getEvent(nameOrSignatureOrTopic: "ApprovalForAll" | "DiscountCost" | "FlowEdgesScopeLastEnded" | "FlowEdgesScopeSingleStarted" | "GroupMint" | "PersonalMint" | "RegisterGroup" | "RegisterHuman" | "RegisterOrganization" | "SetAdvancedUsageFlag" | "Stopped" | "StreamCompleted" | "TransferBatch" | "TransferSingle" | "Trust" | "URI"): EventFragment;
    ...
    encodeFunctionData(functionFragment: "invitationOnlyTime", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "invitationOnlyTime", data: BytesLike): Result;
...
export declare namespace DiscountCostEvent {
    type InputTuple = [
        account: AddressLike,
        id: BigNumberish,
        discountCost: BigNumberish
    ];
    type OutputTuple = [account: string, id: bigint, discountCost: bigint];
    interface OutputObject {
        account: string;
        id: bigint;
        discountCost: bigint;
...
export declare namespace FlowEdgesScopeLastEndedEvent {
    type InputTuple = [];
    type OutputTuple = [];
    interface OutputObject {
    }
...
export declare namespace FlowEdgesScopeSingleStartedEvent {
    type InputTuple = [flowEdgeId: BigNumberish, streamId: BigNumberish];
    type OutputTuple = [flowEdgeId: bigint, streamId: bigint];
    interface OutputObject {
        flowEdgeId: bigint;
        streamId: bigint;
    }
...
export declare namespace GroupMintEvent {
    type InputTuple = [
        sender: AddressLike,
...
export declare namespace RegisterHumanEvent {
    type InputTuple = [avatar: AddressLike, inviter: AddressLike];
    type OutputTuple = [avatar: string, inviter: string];
    interface OutputObject {
        avatar: string;
        inviter: string;
    }
...
export declare namespace SetAdvancedUsageFlagEvent {
    type InputTuple = [avatar: AddressLike, flag: BytesLike];
    type OutputTuple = [avatar: string, flag: string];
    interface OutputObject {
        avatar: string;
        flag: string;
    }
...
export interface Hub extends BaseContract {
    ...
    invitationOnlyTime: TypedContractMethod<[], [bigint], "view">;
    ...
    getFunction(nameOrSignature: "invitationOnlyTime"): TypedContractMethod<[], [bigint], "view">;
    ...
    getEvent(key: "DiscountCost"): TypedContractEvent<DiscountCostEvent.InputTuple, DiscountCostEvent.OutputTuple, DiscountCostEvent.OutputObject>;
    getEvent(key: "FlowEdgesScopeLastEnded"): TypedContractEvent<FlowEdgesScopeLastEndedEvent.InputTuple, FlowEdgesScopeLastEndedEvent.OutputTuple, FlowEdgesScopeLastEndedEvent.OutputObject>;
    getEvent(key: "FlowEdgesScopeSingleStarted"): TypedContractEvent<FlowEdgesScopeSingleStartedEvent.InputTuple, FlowEdgesScopeSingleStartedEvent.OutputTuple, FlowEdgesScopeSingleStartedEvent.OutputObject>;
    getEvent(key: "GroupMint"): TypedContractEvent<GroupMintEvent.InputTuple, GroupMintEvent.OutputTuple, GroupMintEvent.OutputObject>;
    ...
    getEvent(key: "SetAdvancedUsageFlag"): TypedContractEvent<SetAdvancedUsageFlagEvent.InputTuple, SetAdvancedUsageFlagEvent.OutputTuple, SetAdvancedUsageFlagEvent.OutputObject>;
    ...
    filters: {
        ...
        "DiscountCost(address,uint256,uint256)": TypedContractEvent<DiscountCostEvent.InputTuple, DiscountCostEvent.OutputTuple, DiscountCostEvent.OutputObject>;
        DiscountCost: TypedContractEvent<DiscountCostEvent.InputTuple, DiscountCostEvent.OutputTuple, DiscountCostEvent.OutputObject>;
        "FlowEdgesScopeLastEnded()": TypedContractEvent<FlowEdgesScopeLastEndedEvent.InputTuple, FlowEdgesScopeLastEndedEvent.OutputTuple, FlowEdgesScopeLastEndedEvent.OutputObject>;
        FlowEdgesScopeLastEnded: TypedContractEvent<FlowEdgesScopeLastEndedEvent.InputTuple, FlowEdgesScopeLastEndedEvent.OutputTuple, FlowEdgesScopeLastEndedEvent.OutputObject>;
        "FlowEdgesScopeSingleStarted(uint256,uint16)": TypedContractEvent<FlowEdgesScopeSingleStartedEvent.InputTuple, FlowEdgesScopeSingleStartedEvent.OutputTuple, FlowEdgesScopeSingleStartedEvent.OutputObject>;
        FlowEdgesScopeSingleStarted: TypedContractEvent<FlowEdgesScopeSingleStartedEvent.InputTuple, FlowEdgesScopeSingleStartedEvent.OutputTuple, FlowEdgesScopeSingleStartedEvent.OutputObject>;
        "GroupMint(address,address,address,uint256[],uint256[])": TypedContractEvent<GroupMintEvent.InputTuple, GroupMintEvent.OutputTuple, GroupMintEvent.OutputObject>;
        GroupMint: TypedContractEvent<GroupMintEvent.InputTuple, GroupMintEvent.OutputTuple, GroupMintEvent.OutputObject>;
        ...
        "RegisterHuman(address,address)": TypedContractEvent<RegisterHumanEvent.InputTuple, RegisterHumanEvent.OutputTuple, RegisterHumanEvent.OutputObject>;
        ...
        "SetAdvancedUsageFlag(address,bytes32)": TypedContractEvent<SetAdvancedUsageFlagEvent.InputTuple, SetAdvancedUsageFlagEvent.OutputTuple, SetAdvancedUsageFlagEvent.OutputObject>;
        SetAdvancedUsageFlag: TypedContractEvent<SetAdvancedUsageFlagEvent.InputTuple, SetAdvancedUsageFlagEvent.OutputTuple, SetAdvancedUsageFlagEvent.OutputObject>;
