<script lang="ts">
  ...
  import type { AvatarRow, AvatarInfo, AllInvitationsResponse } from '@aboutcircles/sdk-types';
  ...
  onMount(async () => {
    ...
    // avatarInfo is typed as AvatarRow but at runtime contains full AvatarInfo from sdk.data.getAvatar()
    ...
    const response = await sdk.data.getAllInvitations(avatar.avatarInfo.avatar);
