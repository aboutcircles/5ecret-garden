...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 w-full gap-4 mb-8">
  ...
  >
    ...
    <p class="text-sm text-base-content/60">Total Supply</p>
  </div>
  ...
  >
    ...
    <p class="text-sm text-base-content/60">Minted last 30 days</p>
  </div>
  ...
  >
    ...
    <p class="text-sm text-base-content/60">Burned last 30 days</p>
  </div>
  ...
  >
    ...
    <p class="text-sm text-base-content/60">Affiliate Members</p>
  </div>
</div>
