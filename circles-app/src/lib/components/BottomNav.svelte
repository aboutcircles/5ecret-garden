<script lang="ts">
    ...
    function guessIcon(name: string, link: string): Icon {
        const n = name.toLowerCase(); const l = link.toLowerCase();
...
<nav class={`fixed bottom-0 left-1/2 -translate-x-1/2 w-full ${maxWidthClass} z-20`}>
    <div class="btm-nav bg-base-100/90 backdrop-blur-md border-t shadow-md rounded-t-box">
