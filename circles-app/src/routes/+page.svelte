<script lang="ts">
  ...
  import SelectWallet from '$lib/shared/ui/flow/SelectWallet.svelte';
...
<div class="page page-stack page--lg">
  ...
  >
    ...
    <p class="py-6 px-2">
      Mint personal Circles, build trust, and manage your community groups with
      the Circles Core app
    </p>
